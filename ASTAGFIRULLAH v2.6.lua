...
function startBypass()
  gg.setVisible(false)
  bypassAlert = gg.alert("🇮🇩Bypass Now", "Bypass v1", "Bypass v2", "MENU")
...
if HM == 1 then BYPASS1() end
if HM == 2 then WHCLR() end
if HM == 3 then SPECIAL() end
if HM == 4 then NOR() end
if HM == 5 then NOR2() end
if HM == 6 then ANTR() end
if HM == 7 then ANTA() end
if HM == 8 then BSKY() end
if HM == 9 then EXIT() end
	HOMEDM = -1
end
