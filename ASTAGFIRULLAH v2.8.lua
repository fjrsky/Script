...
function SPECIAL()
   SF = gg.multiChoice({
	...
	"⚡Medium Aimbot [ Lobby ]",
	"⚡Headshot 90% [ Game ]",
	"⚡Small Croshair [ Lobby ]",
	"🔸 ↩ B A C K"},
nil, "😈 SPECIAL FEATURES")
  if SF == nil then
  else
	if SF[1] == true then ULTAIM() end
	if SF[2] == true then MEDAIM() end
	if SF[3] == true then HS90() end
	if SF[4] == true then SCHR() end
	if SF[5] == true then HOME() end
   end
end
...
gg.clearResults()
gg.alert("Ultra AimBot has benn active")
end
...
gg.clearResults()
gg.toast("90% HeadShot has benn Active")
end 
